...
CREATE
OR REPLACE FUNCTION "public"."get_customer_stats"() RETURNS "json" LANGUAGE "plpgsql" AS $ $ DECLARE result json;
...
ALTER FUNCTION "public"."get_customer_stats"() OWNER TO "postgres";

CREATE
OR REPLACE FUNCTION "public"."get_reservation_stats"() RETURNS "json" LANGUAGE "plpgsql" AS $ $ DECLARE result json;
...
CREATE
OR REPLACE FUNCTION "public"."get_sales_by_period"("interval_param" "text") RETURNS TABLE(
...
SELECT
  date_trunc(interval_param, o.created_at) AS period_start,
  date_trunc(interval_param, o.created_at) + (
    ('1 ' || interval_param) :: interval - interval '1 microsecond'
  ) AS period_end,
  COALESCE(SUM(o.total) :: bigint, 0) AS total_sales,
  COUNT(o.id) AS order_count
FROM
  orders o
WHERE
  o.status IN ('completed', 'delivered', 'paid', 'processing')
GROUP BY
  period_start
ORDER BY
  period_start DESC;
...
ALTER FUNCTION "public"."get_sales_by_period"("interval_param" "text") OWNER TO "postgres";

CREATE
OR REPLACE FUNCTION "public"."get_sales_by_period"(
  "interval_param" "text",
  "valid_statuses" "text" []
) RETURNS TABLE(
  "period_start" timestamp with time zone,
...
FROM
  orders o
WHERE
  o.status = ANY(valid_statuses)
GROUP BY
  date_trunc(interval_param, o.created_at) -- Corregido: Usa la misma expresión que en el SELECT
ORDER BY
  period_start DESC;
...
ALTER FUNCTION "public"."get_sales_by_period"(
  "interval_param" "text",
  "valid_statuses" "text" []
) OWNER TO "postgres";

CREATE
OR REPLACE FUNCTION "public"."get_sales_summary"() RETURNS TABLE(
  "total_sales" bigint,
  "monthly_sales" bigint,
  "total_orders" bigint
) LANGUAGE "plpgsql" AS $ $ BEGIN RETURN QUERY
SELECT
  COALESCE(SUM(total) :: bigint, 0) AS total_sales,
  COALESCE(
    SUM(
      CASE
        WHEN created_at >= date_trunc('month', CURRENT_DATE) THEN total
        ELSE 0
      END
    ) :: bigint,
    0
...
-- Añade todos los estados relevantes
END;
...
CREATE
OR REPLACE FUNCTION "public"."get_sales_summary"("valid_statuses" "text" []) RETURNS TABLE(
  "total_sales" bigint,
  "monthly_sales" bigint,
  "total_orders" bigint
) LANGUAGE "plpgsql" AS $ $ BEGIN RETURN QUERY
...
ALTER FUNCTION "public"."get_sales_summary"("valid_statuses" "text" []) OWNER TO "postgres";
...
GRANT ALL ON FUNCTION "public"."get_customer_stats"() TO "anon";

GRANT ALL ON FUNCTION "public"."get_customer_stats"() TO "authenticated";

GRANT ALL ON FUNCTION "public"."get_customer_stats"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_sales_by_period"("interval_param" "text") TO "anon";

GRANT ALL ON FUNCTION "public"."get_sales_by_period"("interval_param" "text") TO "authenticated";

GRANT ALL ON FUNCTION "public"."get_sales_by_period"("interval_param" "text") TO "service_role";

GRANT ALL ON FUNCTION "public"."get_sales_by_period"(
  "interval_param" "text",
  "valid_statuses" "text" []
) TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_sales_summary"() TO "anon";

GRANT ALL ON FUNCTION "public"."get_sales_summary"() TO "authenticated";

GRANT ALL ON FUNCTION "public"."get_sales_summary"() TO "service_role";

GRANT ALL ON FUNCTION "public"."get_sales_summary"("valid_statuses" "text" []) TO "anon";

GRANT ALL ON FUNCTION "public"."get_sales_summary"("valid_statuses" "text" []) TO "authenticated";

GRANT ALL ON FUNCTION "public"."get_sales_summary"("valid_statuses" "text" []) TO "service_role";
